...
func (s *Suite) SetupSuite() {
	...
	r.Run(`kubectl apply -k https://github.com/VitalyGushin/deployments-k8s/examples/ovs?ref=5c71dab52788c4f7faffd8ae7f9d77ce30832b00`)
...
func (s *Suite) TestKernel2KernelVLAN() {
	...
	r.Run(`kubectl apply -k https://github.com/VitalyGushin/deployments-k8s/examples/use-cases/Kernel2KernelVLAN?ref=5c71dab52788c4f7faffd8ae7f9d77ce30832b00`)
	r.Run(`kubectl wait --for=condition=ready --timeout=5m pod -l app=nsc-kernel -n ns-kernel2kernel-vlan`)
	r.Run(`kubectl wait --for=condition=ready --timeout=5m pod -l app=nse-kernel -n ns-kernel2kernel-vlan`)
...
func (s *Suite) TestSmartVF2SmartVF() {
	...
	r.Run(`kubectl apply -k https://github.com/VitalyGushin/deployments-k8s/examples/use-cases/SmartVF2SmartVF?ref=5c71dab52788c4f7faffd8ae7f9d77ce30832b00`)
	r.Run(`kubectl -n ns-smartvf2smartvf wait --for=condition=ready --timeout=5m pod -l app=nsc-kernel`)
	r.Run(`kubectl -n ns-smartvf2smartvf wait --for=condition=ready --timeout=5m pod -l app=nse-kernel`)
