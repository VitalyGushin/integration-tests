...
func (s *Suite) TestFloating_forwarder_death() {
	...
	r.Run(`kubectl --kubeconfig=$KUBECONFIG3 apply -k https://github.com/VitalyGushin/deployments-k8s/examples/multicluster_heal/floating-forwarder-death/cluster3?ref=5c71dab52788c4f7faffd8ae7f9d77ce30832b00`)
	r.Run(`kubectl --kubeconfig=$KUBECONFIG2 apply -k https://github.com/VitalyGushin/deployments-k8s/examples/multicluster_heal/floating-forwarder-death/cluster2?ref=5c71dab52788c4f7faffd8ae7f9d77ce30832b00`)
	r.Run(`kubectl --kubeconfig=$KUBECONFIG2 wait --for=condition=ready --timeout=5m pod -l app=nse-kernel -n ns-floating-forwarder-death`)
	r.Run(`kubectl --kubeconfig=$KUBECONFIG1 apply -k https://github.com/VitalyGushin/deployments-k8s/examples/multicluster_heal/floating-forwarder-death/cluster1?ref=5c71dab52788c4f7faffd8ae7f9d77ce30832b00`)
	...
	r.Run(`kubectl --kubeconfig=$KUBECONFIG1 wait --for=condition=ready --timeout=5m pod -l app=forwarder-vpp -n nsm-system`)
	r.Run(`kubectl --kubeconfig=$KUBECONFIG2 wait --for=condition=ready --timeout=5m pod -l app=forwarder-vpp -n nsm-system`)
	r.Run(`kubectl --kubeconfig=$KUBECONFIG1 exec pods/alpine -n ns-floating-forwarder-death -- ping -c 4 172.16.1.2`)
	r.Run(`kubectl --kubeconfig=$KUBECONFIG2 exec deployments/nse-kernel -n ns-floating-forwarder-death -- ping -c 4 172.16.1.3`)
}
func (s *Suite) TestFloating_nse_death() {
	...
	r.Run(`kubectl --kubeconfig=$KUBECONFIG3 apply -k https://github.com/VitalyGushin/deployments-k8s/examples/multicluster_heal/floating-nse-death/cluster3?ref=5c71dab52788c4f7faffd8ae7f9d77ce30832b00`)
	r.Run(`kubectl --kubeconfig=$KUBECONFIG2 apply -k https://github.com/VitalyGushin/deployments-k8s/examples/multicluster_heal/floating-nse-death/cluster2?ref=5c71dab52788c4f7faffd8ae7f9d77ce30832b00`)
	r.Run(`kubectl --kubeconfig=$KUBECONFIG2 wait --for=condition=ready --timeout=5m pod -l app=nse-kernel -n ns-floating-nse-death`)
	r.Run(`kubectl --kubeconfig=$KUBECONFIG1 apply -k https://github.com/VitalyGushin/deployments-k8s/examples/multicluster_heal/floating-nse-death/cluster1?ref=5c71dab52788c4f7faffd8ae7f9d77ce30832b00`)
...
func (s *Suite) TestFloating_nsm_system_death() {
	...
	r.Run(`kubectl --kubeconfig=$KUBECONFIG3 apply -k https://github.com/VitalyGushin/deployments-k8s/examples/multicluster_heal/floating-nsm-system-death/cluster3?ref=5c71dab52788c4f7faffd8ae7f9d77ce30832b00`)
	r.Run(`kubectl --kubeconfig=$KUBECONFIG2 apply -k https://github.com/VitalyGushin/deployments-k8s/examples/multicluster_heal/floating-nsm-system-death/cluster2?ref=5c71dab52788c4f7faffd8ae7f9d77ce30832b00`)
	r.Run(`kubectl --kubeconfig=$KUBECONFIG2 wait --for=condition=ready --timeout=5m pod -l app=nse-kernel -n ns-floating-nsm-system-death`)
	r.Run(`kubectl --kubeconfig=$KUBECONFIG1 apply -k https://github.com/VitalyGushin/deployments-k8s/examples/multicluster_heal/floating-nsm-system-death/cluster1?ref=5c71dab52788c4f7faffd8ae7f9d77ce30832b00`)
...
func (s *Suite) TestInterdomain_nsmgr_death() {
	...
	r.Run(`kubectl --kubeconfig=$KUBECONFIG2 apply -k https://github.com/VitalyGushin/deployments-k8s/examples/multicluster_heal/interdomain-nsmgr-death/cluster2?ref=5c71dab52788c4f7faffd8ae7f9d77ce30832b00`)
	r.Run(`kubectl --kubeconfig=$KUBECONFIG2 wait --for=condition=ready --timeout=5m pod -l app=nse-kernel -n ns-interdomain-nsmgr-death`)
	r.Run(`kubectl --kubeconfig=$KUBECONFIG1 apply -k https://github.com/VitalyGushin/deployments-k8s/examples/multicluster_heal/interdomain-nsmgr-death/cluster1?ref=5c71dab52788c4f7faffd8ae7f9d77ce30832b00`)
	...
	r.Run(`kubectl --kubeconfig=$KUBECONFIG1 wait --for=condition=ready --timeout=5m pod -l app=nsmgr -n nsm-system`)
	r.Run(`kubectl --kubeconfig=$KUBECONFIG2 wait --for=condition=ready --timeout=5m pod -l app=nsmgr -n nsm-system`)
	r.Run(`kubectl --kubeconfig=$KUBECONFIG1 exec pods/alpine -n ns-interdomain-nsmgr-death -- ping -c 4 172.16.1.2`)
	r.Run(`kubectl --kubeconfig=$KUBECONFIG2 exec deployments/nse-kernel -n ns-interdomain-nsmgr-death -- ping -c 4 172.16.1.3`)
}
func (s *Suite) TestInterdomain_proxy_nsmgr_death() {
	...
	r.Run(`kubectl --kubeconfig=$KUBECONFIG2 apply -k https://github.com/VitalyGushin/deployments-k8s/examples/multicluster_heal/interdomain-proxy-nsmgr-death/cluster2?ref=5c71dab52788c4f7faffd8ae7f9d77ce30832b00`)
	r.Run(`kubectl --kubeconfig=$KUBECONFIG2 wait --for=condition=ready --timeout=5m pod -l app=nse-kernel -n ns-interdomain-proxy-nsmgr-death`)
	r.Run(`kubectl --kubeconfig=$KUBECONFIG1 apply -k https://github.com/VitalyGushin/deployments-k8s/examples/multicluster_heal/interdomain-proxy-nsmgr-death/cluster1?ref=5c71dab52788c4f7faffd8ae7f9d77ce30832b00`)
	...
	r.Run(`kubectl --kubeconfig=$KUBECONFIG1 wait --for=condition=ready --timeout=5m pod -l app=nsmgr-proxy -n nsm-system`)
	r.Run(`kubectl --kubeconfig=$KUBECONFIG2 wait --for=condition=ready --timeout=5m pod -l app=nsmgr-proxy -n nsm-system`)
	r.Run(`kubectl --kubeconfig=$KUBECONFIG1 exec pods/alpine -n ns-interdomain-proxy-nsmgr-death -- ping -c 4 172.16.1.2`)
	r.Run(`kubectl --kubeconfig=$KUBECONFIG2 exec deployments/nse-kernel -n ns-interdomain-proxy-nsmgr-death -- ping -c 4 172.16.1.3`)
}
func (s *Suite) TestInterdomain_registry_death() {
	...
	r.Run(`kubectl --kubeconfig=$KUBECONFIG2 apply -k https://github.com/VitalyGushin/deployments-k8s/examples/multicluster_heal/interdomain-registry-death/cluster2?ref=5c71dab52788c4f7faffd8ae7f9d77ce30832b00`)
	r.Run(`kubectl --kubeconfig=$KUBECONFIG2 wait --for=condition=ready --timeout=5m pod -l app=nse-kernel -n ns-interdomain-registry-death`)
	r.Run(`kubectl --kubeconfig=$KUBECONFIG1 apply -k https://github.com/VitalyGushin/deployments-k8s/examples/multicluster_heal/interdomain-registry-death/cluster1?ref=5c71dab52788c4f7faffd8ae7f9d77ce30832b00`)
	...
	r.Run(`kubectl --kubeconfig=$KUBECONFIG2 wait --for=condition=ready --timeout=5m pod -l app=registry -n nsm-system`)
	r.Run(`kubectl --kubeconfig=$KUBECONFIG1 exec pods/alpine -n ns-interdomain-registry-death -- ping -c 4 172.16.1.2`)
	r.Run(`kubectl --kubeconfig=$KUBECONFIG2 exec deployments/nse-kernel -n ns-interdomain-registry-death -- ping -c 4 172.16.1.3`)
}
