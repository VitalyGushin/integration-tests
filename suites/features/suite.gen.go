...
func (s *Suite) TestAnnotated_namespace() {
	...
	r.Run(`kubectl apply -k https://github.com/VitalyGushin/deployments-k8s/examples/features/annotated-namespace?ref=5c71dab52788c4f7faffd8ae7f9d77ce30832b00`)
	r.Run(`kubectl wait --for=condition=ready --timeout=5m pod -l app=nse-kernel -n ns-annotated-namespace`)
	r.Run(`kubectl annotate ns ns-annotated-namespace networkservicemesh.io=kernel://annotated-namespace/nsm-1`)
	r.Run(`kubectl apply -f https://raw.githubusercontent.com/VitalyGushin/deployments-k8s/5c71dab52788c4f7faffd8ae7f9d77ce30832b00/examples/features/annotated-namespace/client.yaml`)
	r.Run(`kubectl wait --for=condition=ready --timeout=5m pod -l app=alpine -n ns-annotated-namespace`)
...
func (s *Suite) TestChange_nse_dynamically() {
	...
	r.Run(`kubectl apply -k https://github.com/VitalyGushin/deployments-k8s/examples/features/change-nse-dynamically?ref=5c71dab52788c4f7faffd8ae7f9d77ce30832b00`)
	r.Run(`kubectl apply -f https://raw.githubusercontent.com/VitalyGushin/deployments-k8s/5c71dab52788c4f7faffd8ae7f9d77ce30832b00/examples/features/change-nse-dynamically/blue-netsvc.yaml`)
	r.Run(`kubectl wait --for=condition=ready --timeout=5m pod -l app=alpine -n ns-change-nse-dynamically`)
	r.Run(`kubectl wait --for=condition=ready --timeout=5m pod -l app=blue-nse -n ns-change-nse-dynamically`)
	r.Run(`kubectl wait --for=condition=ready --timeout=5m pod -l app=green-nse -n ns-change-nse-dynamically`)
	...
	r.Run(`kubectl apply -f https://raw.githubusercontent.com/VitalyGushin/deployments-k8s/5c71dab52788c4f7faffd8ae7f9d77ce30832b00/examples/features/change-nse-dynamically/green-netsvc.yaml`)
...
func (s *Suite) TestDns() {
	...
	r.Run(`kubectl apply -k https://github.com/VitalyGushin/deployments-k8s/examples/features/dns?ref=5c71dab52788c4f7faffd8ae7f9d77ce30832b00`)
...
func (s *Suite) TestKernel2IP2Kernel_dual_stack() {
	...
	r.Run(`kubectl apply -k https://github.com/VitalyGushin/deployments-k8s/examples/features/dual-stack/Kernel2IP2Kernel_dual_stack?ref=5c71dab52788c4f7faffd8ae7f9d77ce30832b00`)
	r.Run(`kubectl wait --for=condition=ready --timeout=5m pod -l app=alpine -n ns-kernel2ip2kernel-dual-stack`)
	r.Run(`kubectl wait --for=condition=ready --timeout=5m pod -l app=nse-kernel -n ns-kernel2ip2kernel-dual-stack`)
...
func (s *Suite) TestKernel2Kernel_dual_stack() {
	...
	r.Run(`kubectl apply -k https://github.com/VitalyGushin/deployments-k8s/examples/features/dual-stack/Kernel2Kernel_dual_stack?ref=5c71dab52788c4f7faffd8ae7f9d77ce30832b00`)
	r.Run(`kubectl wait --for=condition=ready --timeout=5m pod -l app=alpine -n ns-kernel2kernel-dual-stack`)
	r.Run(`kubectl wait --for=condition=ready --timeout=5m pod -l app=nse-kernel -n ns-kernel2kernel-dual-stack`)
...
func (s *Suite) TestExclude_prefixes() {
	...
	r.Run(`kubectl apply -k https://github.com/VitalyGushin/deployments-k8s/examples/features/exclude-prefixes/configmap?ref=5c71dab52788c4f7faffd8ae7f9d77ce30832b00`)
	r.Run(`kubectl apply -k https://github.com/VitalyGushin/deployments-k8s/examples/features/exclude-prefixes?ref=5c71dab52788c4f7faffd8ae7f9d77ce30832b00`)
	r.Run(`kubectl wait --for=condition=ready --timeout=5m pod -l app=alpine -n ns-exclude-prefixes`)
	r.Run(`kubectl wait --for=condition=ready --timeout=5m pod -l app=nse-kernel -n ns-exclude-prefixes`)
...
func (s *Suite) TestExclude_prefixes_client() {
	...
	r.Run(`kubectl apply -k https://github.com/VitalyGushin/deployments-k8s/examples/features/exclude-prefixes-client?ref=5c71dab52788c4f7faffd8ae7f9d77ce30832b00`)
	r.Run(`kubectl wait --for=condition=ready --timeout=5m pod -l app=alpine -n ns-exclude-prefixes-client`)
	r.Run(`kubectl wait --for=condition=ready --timeout=5m pod -l app=nse-kernel-1 -n ns-exclude-prefixes-client`)
	r.Run(`kubectl wait --for=condition=ready --timeout=5m pod -l app=nse-kernel-2 -n ns-exclude-prefixes-client`)
...
func (s *Suite) TestKernel2IP2Kernel_ipv6() {
	...
	r.Run(`kubectl apply -k https://github.com/VitalyGushin/deployments-k8s/examples/features/ipv6/Kernel2IP2Kernel_ipv6?ref=5c71dab52788c4f7faffd8ae7f9d77ce30832b00`)
	r.Run(`kubectl wait --for=condition=ready --timeout=5m pod -l app=alpine -n ns-kernel2ip2kernel-ipv6`)
	r.Run(`kubectl wait --for=condition=ready --timeout=5m pod -l app=nse-kernel -n ns-kernel2ip2kernel-ipv6`)
...
func (s *Suite) TestKernel2IP2Memif_ipv6() {
	...
	r.Run(`kubectl apply -k https://github.com/VitalyGushin/deployments-k8s/examples/features/ipv6/Kernel2IP2Memif_ipv6?ref=5c71dab52788c4f7faffd8ae7f9d77ce30832b00`)
	r.Run(`kubectl wait --for=condition=ready --timeout=5m pod -l app=alpine -n ns-kernel2ip2memif-ipv6`)
	r.Run(`kubectl wait --for=condition=ready --timeout=5m pod -l app=nse-memif -n ns-kernel2ip2memif-ipv6`)
...
func (s *Suite) TestKernel2Kernel_ipv6() {
	...
	r.Run(`kubectl apply -k https://github.com/VitalyGushin/deployments-k8s/examples/features/ipv6/Kernel2Kernel_ipv6?ref=5c71dab52788c4f7faffd8ae7f9d77ce30832b00`)
	r.Run(`kubectl wait --for=condition=ready --timeout=5m pod -l app=alpine -n ns-kernel2kernel-ipv6`)
	r.Run(`kubectl wait --for=condition=ready --timeout=5m pod -l app=nse-kernel -n ns-kernel2kernel-ipv6`)
...
func (s *Suite) TestMemif2IP2Kernel_ipv6() {
	...
	r.Run(`kubectl apply -k https://github.com/VitalyGushin/deployments-k8s/examples/features/ipv6/Memif2IP2Kernel_ipv6?ref=5c71dab52788c4f7faffd8ae7f9d77ce30832b00`)
	r.Run(`kubectl wait --for=condition=ready --timeout=5m pod -l app=nsc-memif -n ns-memif2ip2kernel-ipv6`)
	r.Run(`kubectl wait --for=condition=ready --timeout=5m pod -l app=nse-kernel -n ns-memif2ip2kernel-ipv6`)
...
func (s *Suite) TestMemif2IP2Memif_ipv6() {
	...
	r.Run(`kubectl apply -k https://github.com/VitalyGushin/deployments-k8s/examples/features/ipv6/Memif2IP2Memif_ipv6?ref=5c71dab52788c4f7faffd8ae7f9d77ce30832b00`)
	r.Run(`kubectl wait --for=condition=ready --timeout=5m pod -l app=nsc-memif -n ns-memif2ip2memif-ipv6`)
	r.Run(`kubectl wait --for=condition=ready --timeout=5m pod -l app=nse-memif -n ns-memif2ip2memif-ipv6`)
...
func (s *Suite) TestMemif2Memif_ipv6() {
	...
	r.Run(`kubectl apply -k https://github.com/VitalyGushin/deployments-k8s/examples/features/ipv6/Memif2Memif_ipv6?ref=5c71dab52788c4f7faffd8ae7f9d77ce30832b00`)
	r.Run(`kubectl wait --for=condition=ready --timeout=5m pod -l app=nsc-memif -n ns-memif2memif-ipv6`)
	r.Run(`kubectl wait --for=condition=ready --timeout=5m pod -l app=nse-memif -n ns-memif2memif-ipv6`)
...
func (s *Suite) TestMultiple_services() {
	...
	r.Run(`kubectl apply -k https://github.com/VitalyGushin/deployments-k8s/examples/features/multiple-services?ref=5c71dab52788c4f7faffd8ae7f9d77ce30832b00`)
	r.Run(`kubectl wait --for=condition=ready --timeout=5m pod -l app=alpine -n ns-multiple-services`)
	r.Run(`kubectl wait --for=condition=ready --timeout=5m pod -l app=nse-kernel-1 -n ns-multiple-services`)
	r.Run(`kubectl wait --for=condition=ready --timeout=5m pod -l app=nse-kernel-2 -n ns-multiple-services`)
...
func (s *Suite) TestMutually_aware_nses() {
	...
	r.Run(`kubectl apply -k https://github.com/VitalyGushin/deployments-k8s/examples/features/mutually-aware-nses?ref=5c71dab52788c4f7faffd8ae7f9d77ce30832b00`)
	r.Run(`kubectl wait --for=condition=ready --timeout=5m pod -l app=nsc-kernel -n ns-mutually-aware-nses`)
	r.Run(`kubectl wait --for=condition=ready --timeout=5m pod -l app=nse-kernel-1 -n ns-mutually-aware-nses`)
	r.Run(`kubectl wait --for=condition=ready --timeout=5m pod -l app=nse-kernel-2 -n ns-mutually-aware-nses`)
...
func (s *Suite) TestNse_composition() {
	...
	r.Run(`kubectl apply -k https://github.com/VitalyGushin/deployments-k8s/examples/features/nse-composition?ref=5c71dab52788c4f7faffd8ae7f9d77ce30832b00`)
	r.Run(`kubectl wait --for=condition=ready --timeout=5m pod -l app=alpine -n ns-nse-composition`)
	r.Run(`kubectl wait --for=condition=ready --timeout=5m pod -l app=nse-kernel -n ns-nse-composition`)
...
func (s *Suite) TestOpa() {
	...
	r.Run(`kubectl apply -k https://github.com/VitalyGushin/deployments-k8s/examples/features/opa?ref=5c71dab52788c4f7faffd8ae7f9d77ce30832b00`)
	r.Run(`kubectl wait --for=condition=ready --timeout=5m pod -l app=nsc-kernel -n ns-opa`)
	r.Run(`kubectl wait --for=condition=ready --timeout=5m pod -l app=nse-kernel -n ns-opa`)
...
func (s *Suite) TestPolicy_based_routing() {
	...
	r.Run(`kubectl apply -k https://github.com/VitalyGushin/deployments-k8s/examples/features/policy-based-routing?ref=5c71dab52788c4f7faffd8ae7f9d77ce30832b00`)
	r.Run(`kubectl wait --for=condition=ready --timeout=5m pod -l app=nettools -n ns-policy-based-routing`)
	r.Run(`kubectl wait --for=condition=ready --timeout=5m pod -l app=nse-kernel -n ns-policy-based-routing`)
...
func (s *Suite) TestScale_from_zero() {
	...
	r.Run(`kubectl apply -k https://github.com/VitalyGushin/deployments-k8s/examples/features/scale-from-zero?ref=5c71dab52788c4f7faffd8ae7f9d77ce30832b00`)
	r.Run(`kubectl wait -n ns-scale-from-zero --for=condition=ready --timeout=5m pod -l app=nse-supplier-k8s`)
	r.Run(`kubectl wait -n ns-scale-from-zero --for=condition=ready --timeout=5m pod -l app=alpine`)
	r.Run(`kubectl wait -n ns-scale-from-zero --for=condition=ready --timeout=5m pod -l app=nse-icmp-responder`)
	...
	r.Run(`kubectl wait -n ns-scale-from-zero --for=delete --timeout=5m pod -l app=nse-icmp-responder`)
}
func (s *Suite) TestScaled_registry() {
	...
	r.Run(`kubectl apply -k https://github.com/VitalyGushin/deployments-k8s/examples/features/scaled-registry?ref=5c71dab52788c4f7faffd8ae7f9d77ce30832b00`)
	r.Run(`kubectl wait --for=condition=ready --timeout=5m pod -l app=nse-kernel -n ns-scaled-registry`)
	...
	r.Run(`kubectl wait --for=delete --timeout=5m pod -l app=registry -n nsm-system`)
	r.Run(`kubectl get nses -A | grep $NSE`)
...
func (s *Suite) TestSelect_forwarder() {
	...
	r.Run(`kubectl apply -k https://github.com/VitalyGushin/deployments-k8s/examples/features/select-forwarder?ref=5c71dab52788c4f7faffd8ae7f9d77ce30832b00`)
	r.Run(`kubectl wait --for=condition=ready --timeout=5m pod -l app=alpine -n ns-select-forwarder`)
	r.Run(`kubectl wait --for=condition=ready --timeout=5m pod -l app=nse-kernel -n ns-select-forwarder`)
...
func (s *Suite) TestVl3_basic() {
	...
	r.Run(`kubectl apply -k https://github.com/VitalyGushin/deployments-k8s/examples/features/vl3-basic?ref=5c71dab52788c4f7faffd8ae7f9d77ce30832b00`)
...
func (s *Suite) TestVl3_dns() {
	...
	r.Run(`kubectl apply -k https://github.com/VitalyGushin/deployments-k8s/examples/features/vl3-dns?ref=5c71dab52788c4f7faffd8ae7f9d77ce30832b00`)
...
func (s *Suite) TestVl3_ipv6() {
	...
	r.Run(`kubectl apply -k https://github.com/VitalyGushin/deployments-k8s/examples/features/vl3-ipv6?ref=5c71dab52788c4f7faffd8ae7f9d77ce30832b00`)
...
func (s *Suite) TestVl3_lb() {
	...
	r.Run(`kubectl apply -k https://github.com/VitalyGushin/deployments-k8s/examples/features/vl3-lb?ref=5c71dab52788c4f7faffd8ae7f9d77ce30832b00`)
...
func (s *Suite) TestVl3_scale_from_zero() {
	...
	r.Run(`kubectl apply -k https://github.com/VitalyGushin/deployments-k8s/examples/features/vl3-scale-from-zero?ref=5c71dab52788c4f7faffd8ae7f9d77ce30832b00`)
	r.Run(`kubectl wait -n ns-vl3-scale-from-zero --for=condition=ready --timeout=5m pod -l app=nse-supplier-k8s`)
	r.Run(`kubectl wait -n ns-vl3-scale-from-zero --for=condition=ready --timeout=5m pod -l app=alpine`)
	r.Run(`kubectl wait -n ns-vl3-scale-from-zero --for=condition=ready --timeout=5m pod -l app=nse-vl3-vpp`)
...
func (s *Suite) TestWebhook() {
	...
	r.Run(`kubectl apply -k https://github.com/VitalyGushin/deployments-k8s/examples/features/webhook?ref=5c71dab52788c4f7faffd8ae7f9d77ce30832b00`)
	r.Run(`kubectl wait --for=condition=ready --timeout=5m pod -l app=nse-kernel -n ns-webhook`)
	r.Run(`kubectl wait --for=condition=ready --timeout=5m pod -l app=nettools -n ns-webhook`)
