...
func (s *Suite) SetupSuite() {
	...
	r.Run(`kubectl apply -k https://github.com/VitalyGushin/deployments-k8s/examples/memory?ref=5c71dab52788c4f7faffd8ae7f9d77ce30832b00`)
...
func (s *Suite) TestKernel2Ethernet2Kernel() {
	...
	r.Run(`kubectl apply -k https://github.com/VitalyGushin/deployments-k8s/examples/memory/Kernel2Ethernet2Kernel?ref=5c71dab52788c4f7faffd8ae7f9d77ce30832b00`)
...
func (s *Suite) TestKernel2Kernel() {
	...
	r.Run(`kubectl apply -k https://github.com/VitalyGushin/deployments-k8s/examples/memory/Kernel2Kernel?ref=5c71dab52788c4f7faffd8ae7f9d77ce30832b00`)
...
func (s *Suite) TestMemif2Memif() {
	...
	r.Run(`kubectl apply -k https://github.com/VitalyGushin/deployments-k8s/examples/memory/Memif2Memif?ref=5c71dab52788c4f7faffd8ae7f9d77ce30832b00`)
