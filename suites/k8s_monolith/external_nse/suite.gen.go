...
func (s *Suite) SetupSuite() {
	...
	r.Run(`kubectl apply -k https://github.com/VitalyGushin/deployments-k8s/examples/k8s_monolith/configuration/cluster?ref=5c71dab52788c4f7faffd8ae7f9d77ce30832b00`)
...
func (s *Suite) TestKernel2IP2Kernel() {
	...
	r.Run(`kubectl apply -k https://github.com/VitalyGushin/deployments-k8s/examples/k8s_monolith/external_nse/usecases/Kernel2IP2Kernel?ref=5c71dab52788c4f7faffd8ae7f9d77ce30832b00`)
	r.Run(`kubectl wait --for=condition=ready --timeout=5m pod -l app=alpine -n ns-kernel2ip2kernel-monolith-nse`)
