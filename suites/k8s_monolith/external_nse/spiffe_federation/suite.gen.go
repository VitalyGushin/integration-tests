...
func (s *Suite) SetupSuite() {
	...
	r.Run(`kubectl apply -f https://raw.githubusercontent.com/VitalyGushin/deployments-k8s/5c71dab52788c4f7faffd8ae7f9d77ce30832b00/examples/k8s_monolith/external_nse/spiffe_federation/clusterspiffeid-template.yaml`)
