...
func (s *Suite) SetupSuite() {
	...
	r.Run(`kubectl apply -k https://github.com/VitalyGushin/deployments-k8s/examples/remotevlan_vpp?ref=5c71dab52788c4f7faffd8ae7f9d77ce30832b00`)
...
func (s *Suite) TestKernel2RVlanBreakout() {
	...
	r.Run(`kubectl apply -k https://github.com/VitalyGushin/deployments-k8s/examples/use-cases/Kernel2RVlanBreakout?ref=5c71dab52788c4f7faffd8ae7f9d77ce30832b00`)
	r.Run(`kubectl -n ns-kernel2rvlan-breakout wait --for=condition=ready --timeout=5m pod -l app=iperf1-s`)
...
func (s *Suite) TestKernel2RVlanInternal() {
	...
	r.Run(`kubectl apply -k https://github.com/VitalyGushin/deployments-k8s/examples/use-cases/Kernel2RVlanInternal?ref=5c71dab52788c4f7faffd8ae7f9d77ce30832b00`)
	r.Run(`kubectl -n ns-kernel2rvlan-internal wait --for=condition=ready --timeout=5m pod -l app=iperf1-s`)
...
func (s *Suite) TestKernel2RVlanMultiNS() {
	...
	r.Run(`kubectl apply -k https://github.com/VitalyGushin/deployments-k8s/examples/use-cases/Kernel2RVlanMultiNS/ns-1?ref=5c71dab52788c4f7faffd8ae7f9d77ce30832b00`)
	r.Run(`kubectl apply -f https://raw.githubusercontent.com/VitalyGushin/deployments-k8s/5c71dab52788c4f7faffd8ae7f9d77ce30832b00/examples/use-cases/Kernel2RVlanMultiNS/ns-2/ns-kernel2vlan-multins-2.yaml` + "\n" + `kubectl apply -f https://raw.githubusercontent.com/VitalyGushin/deployments-k8s/5c71dab52788c4f7faffd8ae7f9d77ce30832b00/examples/use-cases/Kernel2RVlanMultiNS/ns-2/netsvc.yaml` + "\n" + `kubectl apply -k https://github.com/VitalyGushin/deployments-k8s/examples/use-cases/Kernel2RVlanMultiNS/ns-2?ref=5c71dab52788c4f7faffd8ae7f9d77ce30832b00`)
	r.Run(`kubectl apply -k https://github.com/VitalyGushin/deployments-k8s/examples/use-cases/Kernel2RVlanMultiNS/ns-3?ref=5c71dab52788c4f7faffd8ae7f9d77ce30832b00`)
	r.Run(`kubectl -n ns-kernel2vlan-multins-1 wait --for=condition=ready --timeout=5m pod -l app=nse-remote-vlan`)
	r.Run(`kubectl -n ns-kernel2vlan-multins-1 wait --for=condition=ready --timeout=5m pod -l app=alpine-1`)
	r.Run(`kubectl -n ns-kernel2vlan-multins-2 wait --for=condition=ready --timeout=5m pod -l app=nse-remote-vlan`)
	r.Run(`kubectl -n ns-kernel2vlan-multins-2 wait --for=condition=ready --timeout=5m pod -l app=alpine-2`)
	r.Run(`kubectl -n ns-kernel2vlan-multins-2 wait --for=condition=ready --timeout=5m pod -l app=alpine-3`)
	r.Run(`kubectl -n ns-kernel2vlan-multins-3 wait --for=condition=ready --timeout=5m pod -l app=alpine-4`)
