...
func (s *Suite) TestNsm_consul() {
	...
	s.T().Cleanup(func() {
		...
		r.Run(`kubectl --kubeconfig=$KUBECONFIG1 delete -f https://raw.githubusercontent.com/VitalyGushin/deployments-k8s/5c71dab52788c4f7faffd8ae7f9d77ce30832b00/examples/interdomain/nsm_consul/server/counting_nsm.yaml` + "\n" + `kubectl --kubeconfig=$KUBECONFIG1 delete -f https://raw.githubusercontent.com/VitalyGushin/deployments-k8s/5c71dab52788c4f7faffd8ae7f9d77ce30832b00/examples/interdomain/nsm_consul/client/dashboard.yaml` + "\n" + `kubectl --kubeconfig=$KUBECONFIG2 delete -k https://github.com/VitalyGushin/deployments-k8s/examples/interdomain/nsm_consul/nse-auto-scale-client?ref=5c71dab52788c4f7faffd8ae7f9d77ce30832b00` + "\n" + `kubectl --kubeconfig=$KUBECONFIG2 delete -k https://github.com/VitalyGushin/deployments-k8s/examples/interdomain/nsm_consul/nse-auto-scale-server?ref=5c71dab52788c4f7faffd8ae7f9d77ce30832b00` + "\n" + `kubectl --kubeconfig=$KUBECONFIG2 delete -f https://raw.githubusercontent.com/VitalyGushin/deployments-k8s/5c71dab52788c4f7faffd8ae7f9d77ce30832b00/examples/interdomain/nsm_consul/service.yaml` + "\n" + `kubectl --kubeconfig=$KUBECONFIG2 delete -f https://raw.githubusercontent.com/VitalyGushin/deployments-k8s/5c71dab52788c4f7faffd8ae7f9d77ce30832b00/examples/interdomain/nsm_consul/server/counting_service.yaml` + "\n" + `kubectl --kubeconfig=$KUBECONFIG2 delete -f https://raw.githubusercontent.com/VitalyGushin/deployments-k8s/5c71dab52788c4f7faffd8ae7f9d77ce30832b00/examples/interdomain/nsm_consul/netsvc.yaml` + "\n" + `kubectl --kubeconfig=$KUBECONFIG2 delete pods --all`)
	...
	r.Run(`kubectl --kubeconfig=$KUBECONFIG2 apply -f https://raw.githubusercontent.com/VitalyGushin/deployments-k8s/5c71dab52788c4f7faffd8ae7f9d77ce30832b00/examples/interdomain/nsm_consul/server/counting_service.yaml`)
	r.Run(`kubectl --kubeconfig=$KUBECONFIG2 apply -f https://raw.githubusercontent.com/VitalyGushin/deployments-k8s/5c71dab52788c4f7faffd8ae7f9d77ce30832b00/examples/interdomain/nsm_consul/server/counting.yaml`)
	r.Run(`kubectl --kubeconfig=$KUBECONFIG2 apply -f https://raw.githubusercontent.com/VitalyGushin/deployments-k8s/5c71dab52788c4f7faffd8ae7f9d77ce30832b00/examples/interdomain/nsm_consul/netsvc.yaml`)
	r.Run(`kubectl --kubeconfig=$KUBECONFIG2 apply -k https://github.com/VitalyGushin/deployments-k8s/examples/interdomain/nsm_consul/nse-auto-scale-client?ref=5c71dab52788c4f7faffd8ae7f9d77ce30832b00` + "\n" + `kubectl --kubeconfig=$KUBECONFIG2 apply -k https://github.com/VitalyGushin/deployments-k8s/examples/interdomain/nsm_consul/nse-auto-scale-server?ref=5c71dab52788c4f7faffd8ae7f9d77ce30832b00`)
	r.Run(`kubectl --kubeconfig=$KUBECONFIG2 apply -f https://raw.githubusercontent.com/VitalyGushin/deployments-k8s/5c71dab52788c4f7faffd8ae7f9d77ce30832b00/examples/interdomain/nsm_consul/service.yaml`)
	r.Run(`kubectl --kubeconfig=$KUBECONFIG1 apply -f https://raw.githubusercontent.com/VitalyGushin/deployments-k8s/5c71dab52788c4f7faffd8ae7f9d77ce30832b00/examples/interdomain/nsm_consul/client/dashboard.yaml`)
	...
	r.Run(`kubectl --kubeconfig=$KUBECONFIG1 apply -f https://raw.githubusercontent.com/VitalyGushin/deployments-k8s/5c71dab52788c4f7faffd8ae7f9d77ce30832b00/examples/interdomain/nsm_consul/server/counting_nsm.yaml`)
...
func (s *Suite) TestNsm_istio() {
	...
	s.T().Cleanup(func() {
		r.Run(`kubectl --kubeconfig=$KUBECONFIG2 delete -f https://raw.githubusercontent.com/VitalyGushin/deployments-k8s/5c71dab52788c4f7faffd8ae7f9d77ce30832b00/examples/interdomain/nsm_istio/greeting/server.yaml` + "\n" + `kubectl --kubeconfig=$KUBECONFIG2 delete -k https://github.com/VitalyGushin/deployments-k8s/examples/interdomain/nsm_istio/nse-auto-scale?ref=5c71dab52788c4f7faffd8ae7f9d77ce30832b00` + "\n" + `kubectl --kubeconfig=$KUBECONFIG1 delete -f https://raw.githubusercontent.com/VitalyGushin/deployments-k8s/5c71dab52788c4f7faffd8ae7f9d77ce30832b00/examples/interdomain/nsm_istio/greeting/client.yaml` + "\n" + `kubectl --kubeconfig=$KUBECONFIG2 delete -f https://raw.githubusercontent.com/VitalyGushin/deployments-k8s/5c71dab52788c4f7faffd8ae7f9d77ce30832b00/examples/interdomain/nsm_istio/netsvc.yaml` + "\n" + `kubectl --kubeconfig=$KUBECONFIG2 delete ns istio-system` + "\n" + `kubectl --kubeconfig=$KUBECONFIG2 label namespace default istio-injection-` + "\n" + `kubectl --kubeconfig=$KUBECONFIG2 delete pods --all`)
	})
	...
	r.Run(`kubectl --kubeconfig=$KUBECONFIG2 apply -f https://raw.githubusercontent.com/VitalyGushin/deployments-k8s/5c71dab52788c4f7faffd8ae7f9d77ce30832b00/examples/interdomain/nsm_istio/netsvc.yaml`)
	r.Run(`kubectl --kubeconfig=$KUBECONFIG1 apply -f https://raw.githubusercontent.com/VitalyGushin/deployments-k8s/5c71dab52788c4f7faffd8ae7f9d77ce30832b00/examples/interdomain/nsm_istio/greeting/client.yaml`)
	r.Run(`kubectl --kubeconfig=$KUBECONFIG2 apply -k https://github.com/VitalyGushin/deployments-k8s/examples/interdomain/nsm_istio/nse-auto-scale?ref=5c71dab52788c4f7faffd8ae7f9d77ce30832b00`)
	r.Run(`kubectl --kubeconfig=$KUBECONFIG2 label namespace default istio-injection=enabled` + "\n" + `` + "\n" + `kubectl --kubeconfig=$KUBECONFIG2 apply -f https://raw.githubusercontent.com/VitalyGushin/deployments-k8s/5c71dab52788c4f7faffd8ae7f9d77ce30832b00/examples/interdomain/nsm_istio/greeting/server.yaml`)
...
func (s *Suite) TestNsm_kuma_universal_vl3() {
	...
	r.Run(`kubectl --kubeconfig=$KUBECONFIG1 apply -k https://github.com/VitalyGushin/deployments-k8s/examples/interdomain/nsm_kuma_universal_vl3/vl3-dns?ref=5c71dab52788c4f7faffd8ae7f9d77ce30832b00` + "\n" + `kubectl --kubeconfig=$KUBECONFIG1 -n ns-dns-vl3 wait --for=condition=ready --timeout=5m pod -l app=vl3-ipam`)
	...
	r.Run(`kubectl --kubeconfig=$KUBECONFIG1 apply -f https://raw.githubusercontent.com/VitalyGushin/deployments-k8s/5c71dab52788c4f7faffd8ae7f9d77ce30832b00/examples/interdomain/nsm_kuma_universal_vl3/namespace.yaml` + "\n" + `kubectl --kubeconfig=$KUBECONFIG1 create secret generic general-tls-certs --namespace=kuma-system --from-file=./tls.key --from-file=./tls.crt --from-file=./ca.crt`)
	...
	r.Run(`cat > kustomization.yaml <<EOF` + "\n" + `---` + "\n" + `apiVersion: kustomize.config.k8s.io/v1beta1` + "\n" + `kind: Kustomization` + "\n" + `` + "\n" + `resources:` + "\n" + `- control-plane.yaml` + "\n" + `` + "\n" + `patches:` + "\n" + `- path: https://raw.githubusercontent.com/VitalyGushin/deployments-k8s/5c71dab52788c4f7faffd8ae7f9d77ce30832b00/examples/interdomain/nsm_kuma_universal_vl3/patch-control-plane.yaml` + "\n" + `EOF`)
	r.Run(`kubectl --kubeconfig=$KUBECONFIG1 apply -k .`)
	r.Run(`kubectl --kubeconfig=$KUBECONFIG1 apply -f https://raw.githubusercontent.com/VitalyGushin/deployments-k8s/5c71dab52788c4f7faffd8ae7f9d77ce30832b00/examples/interdomain/nsm_kuma_universal_vl3/demo-redis.yaml` + "\n" + `kubectl --kubeconfig=$KUBECONFIG1 -n kuma-demo wait --for=condition=ready --timeout=5m pod -l app=redis`)
	r.Run(`kubectl --kubeconfig=$KUBECONFIG2 apply -f https://raw.githubusercontent.com/VitalyGushin/deployments-k8s/5c71dab52788c4f7faffd8ae7f9d77ce30832b00/examples/interdomain/nsm_kuma_universal_vl3/demo-app.yaml` + "\n" + `kubectl --kubeconfig=$KUBECONFIG2 -n kuma-demo wait --for=condition=ready --timeout=5m pod -l app=demo-app`)
